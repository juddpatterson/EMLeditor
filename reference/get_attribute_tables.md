...
`get_attribute_tables` takes an EML object and returns a nested table of
all the attribute tables pulled from the metadata, using
EML::get_attributes()
...
a nested table with one attribute table for each data table in the EML
file
